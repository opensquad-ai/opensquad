...
from opensquad.tool_call_strategy import NativeToolCallStrategy, ToolCallStrategySelector, XMLToolCallStrategy
...
class TestToolCallStrategySelector:
    ...
    def test_select_xml_mode_explicit(self):
        ...
        config = {"model": {"provider": "openai_compat", "model_name": "glm-5", "tool_call_mode": "xml"}}
        mock_registry = Mock()
    ...
    def test_select_native_mode_explicit(self):
        ...
        config = {"model": {"provider": "openai_compat", "model_name": "glm-5", "tool_call_mode": "native"}}
        mock_registry = Mock()
        mock_registry.generate_openai_tools.return_value = []
    ...
    def test_select_auto_mode_glm5(self):
        ...
        config = {"model": {"provider": "openai_compat", "model_name": "glm-5", "tool_call_mode": "auto"}}
        mock_registry = Mock()
        mock_registry.generate_openai_tools.return_value = []
