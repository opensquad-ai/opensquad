...
def test_integration():
    ...
    if strategy_name == "Native-FC":
        ...
        if read_file_tool:
            print("  ✓ 找到工具: filesystem__read_file")
            ...
            print("  ⚠ 未找到 filesystem__read_file 工具")
        ...
        print("  ✓ System Prompt 包含工具描述")
        print("  ✓ 不提供 tools 参数（使用 XML 格式）")
    ...
    if strategy_name == "Native-FC":
        ...
        print("✓ 工具参数描述已从 docstring 提取")

    print("\n下一步：")
    print("  1. 启动 Agent: python agents_boot.py ultimate")
    print("  2. 在日志中查找 '[Runner] Tool call strategy: Native-FC'")
    print("  3. 测试工具调用并观察成功率")
