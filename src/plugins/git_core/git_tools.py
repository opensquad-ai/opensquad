...
def _run_git(repo_path: str, args: List[str], env: Optional[Dict[str, str]] = None) -> str:
...
def commit(path: str, message: str, author_name: Optional[str] = None, author_email: Optional[str] = None) -> str:
...
def branch(path: str, name: Optional[str] = None, delete: bool = False) -> str:
...
def push(path: str, remote: str = "origin", branch: Optional[str] = None, set_upstream: bool = False) -> str:
