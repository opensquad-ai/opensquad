...
class MessageQueue:
    ...
    def __init__(self, max_size: int = 1000):
        ...
        self._new_message_event: Optional[asyncio.Event] = None
    ...
    async def get(self, timeout: float = 0.1) -> Optional[QueueMessage]:
...
def parse_websocket_message(data: Dict) -> Optional[QueueMessage]:
