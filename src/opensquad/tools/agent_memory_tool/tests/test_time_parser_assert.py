...
assert_test(
    "\u53bb\u5e74-keywords_contain_repair",
    "\u7ef4\u4fee" in r["keywords"] or "\u6c7d\u8f66\u7ef4\u4fee" in r["keywords"],
)
...
r = parse_time_expression(
    "\u4eca\u5e745\u6708\u4efd\u52308\u6708\u4efd\u7684\u5c71\u59c6\u5723\u8bde\u8d60\u793c\u6d3b\u52a8", now=NOW
)
assert_test("\u6708\u8303\u56f4-time_expr", r["time_expr"] == "\u4eca\u5e745\u6708\u4efd\u52308\u6708\u4efd")
assert_test(
    "\u6708\u8303\u56f4-start_may", datetime.datetime.fromtimestamp(r["time_range"][0]).strftime("%Y-%m") == "2026-05"
)
assert_test(
    "\u6708\u8303\u56f4-end_aug", datetime.datetime.fromtimestamp(r["time_range"][1]).strftime("%Y-%m") == "2026-08"
)
...
assert_test("\u524d\u5e74-year_correct", datetime.datetime.fromtimestamp(r["time_range"][0]).strftime("%Y") == "2024")
...
assert_test(
    "N\u6708\u524d-start_dec", datetime.datetime.fromtimestamp(r["time_range"][0]).strftime("%Y-%m-%d") == "2025-12-11"
)

# 11. Year 2024 -> full year
r = parse_time_expression("2024\u5e74\u7684\u65c5\u884c\u8ba1\u5212", now=NOW)
assert_test("2024\u5e74-time_expr", r["time_expr"] == "2024\u5e74")
assert_test("2024\u5e74-year_correct", datetime.datetime.fromtimestamp(r["time_range"][0]).strftime("%Y") == "2024")
...
assert_test(
    "\u672c\u6708-month_correct", datetime.datetime.fromtimestamp(r["time_range"][0]).strftime("%Y-%m") == "2026-02"
)
...
assert_test(
    "C1-desc_verb-original_text_preserved",
    r["cleaned_text"] == "\u90a3\u7bc7\u6587\u7ae0\u91cc\u63d0\u5230\u4e0a\u5468\u7684\u5e02\u573a\u6ce2\u52a8",
)
